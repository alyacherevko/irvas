...
var windowForms = ['3 стекла', '4 стекла (изогнутые)', '4 cтекла (прямые)', '4 стекла (квадрат)'];
...
var changeModalState = function changeModalState(state) {
  ...
  var bindActionElems = function bindActionElems(event, elem, prop) {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    var target = e.target;
    var elTarget = target.classList.contains(tabSelector.replace(/\./, ""));
    var parentTarget = target.parentNode.classList.contains(tabSelector.replace(/\./, ""));

    if (target && (elTarget || parentTarget)) {
